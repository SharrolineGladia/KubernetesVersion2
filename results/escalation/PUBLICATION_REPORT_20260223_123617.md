...
**Generated:** February 23, 2026 at 12:36:19
...
|-------------|-----------------|--------------------|-----------------------|----------|------------------|
| 0.6 | 0.3% | 0.00 | 20.13 ± 1.94 | 99.51% | 99.7% / 0.3% |
| 0.7 | 0.8% | 0.01 | 20.42 ± 1.93 | 99.52% | 99.2% / 0.8% |
| 0.8 | 1.1% | 0.01 | 20.59 ± 1.93 | 99.54% | 98.9% / 1.1% |
| 0.9 | 1.5% | 0.01 | 20.81 ± 1.93 | 99.56% | 98.5% / 1.5% |
...
- Mean edge-only latency: 19.96 ms
- Mean escalated latency: 76.57 ms
- Escalation overhead: 56.61 ms (283.6% increase)

**Expected Latency by Threshold:**
- θ = 0.6: 20.13 ms [99.7% edge, 0.3% cloud]
- θ = 0.7: 20.42 ms [99.2% edge, 0.8% cloud]
- θ = 0.8: 20.59 ms [98.9% edge, 1.1% cloud]
- θ = 0.9: 20.81 ms [98.5% edge, 1.5% cloud]

**Optimal Configuration:**
- Lowest expected latency at θ = 0.6
- Expected latency: 20.13 ms
...
3. **Latency-Accuracy Trade-off**: The system exhibits a Pareto frontier between latency (20.13-20.81 ms) and accuracy (99.51%-99.56%), enabling application-specific optimization based on operational requirements.
...
5. **Recommended Configuration**: Based on multi-objective optimization balancing bandwidth, latency, and accuracy, θ = 0.6 emerges as optimal, achieving 99.51% accuracy with 0.00 MB/day bandwidth consumption and 20.13 ms expected latency.
...
$\theta$ & Rate (\%) & (MB/day) & (ms) & (\%) \\
\hline
0.6 & 0.3 & 0.00 & 20.13 $\pm$ 1.94 & 99.51 \\
0.7 & 0.8 & 0.01 & 20.42 $\pm$ 1.93 & 99.52 \\
0.8 & 1.1 & 0.01 & 20.59 $\pm$ 1.93 & 99.54 \\
0.9 & 1.5 & 0.01 & 20.81 $\pm$ 1.93 & 99.56 \\
\hline
\end{tabular}
\end{table}
```
